import CurrencySelection from "../OpenCartPageObjects/CurrencySelection";
...
describe('Currency Selection', () => {
    ...
    it('Ensure that when the user selects a new currency, the total order price (including taxes and shipping) is updated correctly.', () => {
        CurrencySelection.selectCurrency('Euro');
